...
class Resultado():
    ...
    def macro_f1(self):
        ...
        return np.average(np.array(list(self.f1_por_classe.values())))

    @property
    def acuracia(self):
        print(self.mat_confusao)
...
class Fold():
    ...
    @staticmethod
    def gerar_k_folds(df_dados:pd.DataFrame,val_k:int,col_classe:str,num_repeticoes:int=1,seed:int=1,
        ...
        for num_repeticao in range(num_repeticoes):
            ...
            for num_fold in range(val_k):
                ...
                if num_fold < val_k-1:
                    ...
                    fim_fold_to_predict = df_dados.shape[0]
                ...
                df_to_predict = df_dados_rand.iloc[ini_fold_to_predict:fim_fold_to_predict]
                #print(df_to_predict)
